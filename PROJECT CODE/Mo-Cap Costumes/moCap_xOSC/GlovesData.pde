...
public class GlovesData {
  ...
  {  
    ...
    {
      int i = 0;
      flexL[0] = theOscMessage.get(0).floatValue();
      flexL[1] = theOscMessage.get(1).floatValue();
      flexL[2] = theOscMessage.get(2).floatValue();
      flexL[3] = theOscMessage.get(3).floatValue();
      flexL[4] = theOscMessage.get(4).floatValue();
      flexL[5] = theOscMessage.get(5).floatValue();
      flexL[6] = theOscMessage.get(6).floatValue();
      flexL[7] = theOscMessage.get(7).floatValue();
      flexL[8] = theOscMessage.get(8).floatValue();    
    }
