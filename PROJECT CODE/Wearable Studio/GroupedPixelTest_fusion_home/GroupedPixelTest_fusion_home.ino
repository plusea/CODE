...
// only upper case
// space = [
const int foxTextLength = 43;
char foxText[foxTextLength+1] = "THE[QUICK[BROWN[FOX[JUMPS[OVER[THE[LAZY[DOG";
...
void loop()
{
   for (int i = 0; i< foxTextLength;i++){
      alphabetSetter(foxText[i]);
