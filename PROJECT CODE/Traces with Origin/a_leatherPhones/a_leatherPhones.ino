...
#define sensorPin 3 //keep! or else update pullup pin#
#define speakerPin 4 //change
...
void playMelody(){
  myTone(speakerPin, 2093, 500);
  myTone(speakerPin, 2349, 500);
  myTone(speakerPin, 2637, 500);
  myTone(speakerPin, 2793, 500);
  myTone(speakerPin, 3136, 500);
  myTone(speakerPin, 3520, 500);
  myTone(speakerPin, 3951, 500);
  myTone(speakerPin, 4186, 500);
}
