...
public class GlovesData {
  ...
  public float[] flexL = new float[9];
  ...
  public void setLeftLEDColour(int red, int green, int blue)
  {
    {
      // create an osc message
      OscMessage m = new OscMessage("/output/pwm/duty/5");
      m.add(red); // add an int to the osc message
      oscP5.send(m, destination);
    }
   {
      // create an osc message
      OscMessage m = new OscMessage("/output/pwm/duty/6");
      m.add(green); // add an int to the osc message
      oscP5.send(m, destination);
    }
    {
      // create an osc message
      OscMessage m = new OscMessage("/output/pwm/duty/7");
  ...
  {  
    ...
    {
      int i = 0;
      flexL[0] = theOscMessage.get(4).floatValue();
      flexL[1] = theOscMessage.get(5).floatValue();
      flexL[2] = theOscMessage.get(6).floatValue();
      flexL[3] = theOscMessage.get(7).floatValue();
      flexL[4] = theOscMessage.get(9).floatValue();
      flexL[5] = theOscMessage.get(10).floatValue();
      flexL[6] = theOscMessage.get(11).floatValue();
      flexL[7] = theOscMessage.get(12).floatValue();
      flexL[8] = theOscMessage.get(13).floatValue();    
    }
