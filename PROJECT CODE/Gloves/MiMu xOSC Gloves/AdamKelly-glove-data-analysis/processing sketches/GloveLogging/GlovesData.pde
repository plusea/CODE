...
public class GlovesData {
  ...
  public float[] flexL = new float[9];  // modifed for x-OSC
  ...
  public GlovesData() {
    ...
    destination = new NetAddress("127.0.0.1", 8001);
  ...
  {  
    ...
    if (messageType.equals("/input/analog"))     // modifed for x-OSC
    {
      int i = 0;
      flexL[0
      ] = theOscMessage.get(i++).floatValue();
      flexL[1] = theOscMessage.get(i++).floatValue();
      flexL[2] = theOscMessage.get(i++).floatValue();
      flexL[3] = theOscMessage.get(i++).floatValue();
      flexL[4] = theOscMessage.get(i++).floatValue();
      flexL[5] = theOscMessage.get(i++).floatValue();
      flexL[6] = theOscMessage.get(i++).floatValue();
      flexL[7] = theOscMessage.get(i++).floatValue();
      flexL[8] = theOscMessage.get(i++).floatValue();    
    }
