void circle() {
  ...
  background(255);
  text("press 'g' for graph", 50, 50);
  text("press 'v' for visualization", 50, 100);
  text("press 'arrow up' to increase threshold", 50, 150);
  text("press 'arrow down' to decrease threshold", 50, 200);
  ellipseMode(RADIUS);
