 ...
 * is an abstract class that implements the interface
<code>AudioSignal</code>.
 ...
 * merely provides the functionality of smoothly changing frequency,
amplitude
 ...
 * <b>freq</b> is the current frequency (in Hertz) of the
