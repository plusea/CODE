...
class SSFirmataClass
{
public:
	SSFirmataClass(SoftwareSerial &s);
...
/* serial send handling */
    ...
    void blePrintSendBuffer();
    void blePrintSendBufferBetweenStartAndEnd();
...
/* input message handling */
    ...
    int sendBufferStart;
    int sendBufferCount;
    byte sendBuffer[SEND_BUFFER_SIZE]; // multi-byte data
...
extern SSFirmataClass SSFirmata;
